...
CREATE TABLE `class` (
  ...
  `class_professor_num` varchar(45) DEFAULT NULL,
  `class_room` varchar(45) DEFAULT NULL,
  `class_schedule` varchar(45) DEFAULT NULL,
  `class_year` varchar(45) DEFAULT NULL,
...
INSERT INTO `class` VALUES ('c100','a111','p100',NULL,'월','2019','1학기'),('c200','a111','p100',NULL,'금','2019','2학기'),('c300','a222','p200',NULL,'수','2018','1학기'),('c400','a333','p100',NULL,'화','2018','1학기'),('c500','a777','p300',NULL,'목','2017','2학기');
