...
CREATE TABLE `requirement` (
  `requirement_num` varchar(45) NOT NULL,
  `requirement_entrance_year` varchar(45) DEFAULT NULL,
  ...
  `requirement_general_point` varchar(45) DEFAULT NULL,
  `requirement_english` varchar(45) DEFAULT NULL,
  `requirement_project` varchar(45) NOT NULL,
...
-- Dump completed on 2019-04-26 15:32:10
